...
class ARBatchSampler(Sampler):
    def __init__(self, data_source, batch_size, drop_last=False, epoch=0, is_train = True):
...
class DistributedARBatchSampler(ARBatchSampler):
    def __init__(self, data_source, batch_size, num_replicas=None, rank=None, drop_last=False, epoch=0, is_train=True):
        super(DistributedARBatchSampler, self).__init__(data_source, batch_size, drop_last, epoch, is_train)
