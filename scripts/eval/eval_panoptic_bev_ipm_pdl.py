...
from panoptic_bev.modules.ms_transformer_ipm import MultiScaleTransformerVF
...
from panoptic_bev.models.panoptic_bev_ipm_pdl import PanopticBevNet, NETWORK_INPUTS

# from panoptic_bev.algos.transformer_ipm import TransformerVFAlgo, TransformerVFLoss, TransformerRegionSupervisionLoss
...
def make_model(args, config, num_thing, num_stuff):
    ...
    vf_loss = None # TransformerVFLoss()
    region_supervision_loss = None # TransformerRegionSupervisionLoss()
    transformer_algo = None # TransformerVFAlgo(vf_loss, region_supervision_loss)
