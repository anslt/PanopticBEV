...
from panoptic_bev.utils.panoptic import compute_panoptic_test_metrics2, panoptic_post_processing, get_panoptic_scores
...
def test(model, dataloader, **varargs):
    ...
    for it, sample in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            panoptic_buffer, po_conf_mat = compute_panoptic_test_metrics2(panoptic_pred_list, panoptic_buffer,
